...
## ◉ GOLOCODE — โค้ดดิ้ง AI 100 เอเจนต์ (โปรเจกต์ที่สองใน repo นี้)

ในโฟลเดอร์ [`golocode/`](golocode/) มีอีกโปรเจกต์หนึ่งที่แยกจากเว็บเกมด้านบน:
**GOLOCODE** — เครื่องมือช่วยเขียนโค้ดที่มีเอเจนต์ผู้เชี่ยวชาญ 100 ตัว
พิมพ์งานอะไรลงไปก็ได้ ระบบจะเลือกทีมที่เหมาะกับงานนั้น ทำงานเป็น 5 เฟส
แล้วส่งคืนเป็นโค้ดที่รันได้
...
ใช้ได้ทันทีโดยไม่ต้องมี API key (โหมด Local Blueprint — วางแผน จัดทีม สร้างโครงไฟล์)
และถ้าใส่ Anthropic API key จะรันทีมจริงผ่าน Claude API ได้ (โหมด Live)

รายละเอียดทั้งหมดอยู่ที่ [`golocode/README.md`](golocode/README.md)
